...
class AppConfig {
  ...
  static const String pswBaseUrl =
      'http://35.189.162.86/Max_plant/psw_setting.php';

  // NEW: Home / Plant
  static const String homepageBaseUrl =
      'http://35.189.162.86/Max_plant/homepage_setting.php';
  static const String plantBaseUrl =
      'http://35.189.162.86/Max_plant/plant_setting.php';
}
